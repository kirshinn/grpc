...
class GreetingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.greeting = channel.unary_stream(
                '/org.example.grpc.GreetingService/greeting',
...
def add_GreetingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'org.example.grpc.GreetingService', rpc_method_handlers)
...
class GreetingService(object):
    ...
    def greeting(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/org.example.grpc.GreetingService/greeting',
